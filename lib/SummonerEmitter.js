...
SummonerEmitter.prototype.setName = function(name) {
    this.name = name;
}
...
SummonerEmitter.prototype.setSocket = function(socket) {
    this.socket = socket;
}

SummonerEmitter.prototype.getSocket = function() {
    return this.socket;
}

SummonerEmitter.prototype.socketEmit = function(state, data) {
